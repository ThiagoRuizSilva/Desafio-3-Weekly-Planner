...
async function handleRegister(e) {
  ...
  if (email !== '' && password !== '') {
    ...
    // Resto do código para o registro
    ...
    <div className={styles.container__form}>
      ...
      <form className={styles.form_id} onSubmit={handleRegister}>
        <div className="first__name">
          ...
          <input type="text" placeholder="Your first name" value={firstName} onChange={(e) => setFirstName(capitalizeFirstLetter(e.target.value))} />
        </div>

        <div>
          <label htmlFor="meuInput">last name</label>
          <input type="text" placeholder="Your last name" value={lastName} onChange={(e) => setLastName(capitalizeFirstLetter(e.target.value))} />
        </div>

        <div>
          <label htmlFor="meuInput">birth date</label>
          <input type="text" placeholder="MM/DD/YYYY"  value={formatBirthdate(birthdate)} onChange={(e) => setBirthdate(e.target.value)}/>
        </div>
